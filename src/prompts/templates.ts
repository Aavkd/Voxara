...
export const PROMPT_TEMPLATES: PromptTemplateDefinition[] = [
  ...
  },
  {
    ...
    fallback: [
      ...
      "- workspace_write tasks run in an isolated Git worktree: the user's own files are never modified. The result reports a diff and a patch file to review — present it that way, offer the next step (review or apply), and never claim files were changed in place.",
